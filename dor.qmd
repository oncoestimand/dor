...
# Packages
# --------------------------------------------------------------
packages <- c("gtsummary", "survival", "cmprsk", "survminer", "msm", "mstate", "tidyverse",
            "gt", "survRM2", "PBIR", "labelled", "swimplot", "ggplot2")
...
# For patients with no OR nor PD use last assessment (censored, could get response 
# if further assessments taken). 
...
fit_cTTR <- survfit(Surv(months(data.res$ttr), data.res$or) ~ 1, data = data.res) 
